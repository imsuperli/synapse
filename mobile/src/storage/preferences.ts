...
const PINS_PREFIX = 'synapse:pins:'
const NOTIF_KEY = 'synapse:pushNotificationsEnabled'
...
const AUTOCOMPLETE_KEY = 'synapse:terminalAutocompleteEnabled'
...
const TERMINAL_LIVE_INPUT_DISABLED_PREFIX = 'synapse:terminalLiveInputDisabled:'
...
const SIDEBAR_WIDTH_KEY = 'synapse:hostSidebarWidth'
...
const DOCK_WIDTH_KEY = 'synapse:hostDockWidth'
...
export type MobileTerminalLinkOpenMode = 'synapse-browser' | 'phone-browser'

const TERMINAL_LINK_OPEN_MODE_KEY = 'synapse:terminalLinkOpenMode'
export const DEFAULT_TERMINAL_LINK_OPEN_MODE: MobileTerminalLinkOpenMode = 'synapse-browser'
...
export async function loadTerminalLinkOpenMode(): Promise<MobileTerminalLinkOpenMode> {
  try {
    ...
    return raw === 'phone-browser' || raw === 'synapse-browser' ? raw : DEFAULT_TERMINAL_LINK_OPEN_MODE
  } catch {
